...
class _NewEntryPageState extends State<NewEntryPage> {
  ...
  Future<void> scheduleNotification(Medicine medicine) async {
    int hour = int.parse(medicine.startTime![0] + medicine.startTime![1]);
    int minute = int.parse(medicine.startTime![2] + medicine.startTime![3]);
    final int originalHour = hour;
    ...
    final tz.TZDateTime scheduledTimetmp =
